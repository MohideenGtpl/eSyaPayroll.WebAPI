...
namespace eSyaPayroll.DL.Entities
{
    public partial class eSyaEnterprise : DbContext
    {
        ...
        public virtual DbSet<GtEpyata> GtEpyata { get; set; }
        public virtual DbSet<GtEpyatp> GtEpyatp { get; set; }
        ...
        public virtual DbSet<GtEpypve> GtEpypve { get; set; }
        public virtual DbSet<GtEpypyp> GtEpypyp { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<GtEpyata>(entity =>
            {
                entity.HasKey(e => new { e.BusinessKey, e.EmployeeNumber, e.PayPeriod, e.PaidPeriod });

                entity.ToTable("GT_EPYATA");

                entity.Property(e => e.ArrearDays).HasColumnType("decimal(9, 6)");
            ...
            modelBuilder.Entity<GtEpyatp>(entity =>
            {
                entity.HasKey(e => new { e.BusinessKey, e.EmployeeNumber, e.PayPeriod });

                entity.ToTable("GT_EPYATP");

                entity.Property(e => e.AbsentDays).HasColumnType("decimal(9, 6)");
                ...
                entity.Property(e => e.Holidays).HasColumnType("decimal(9, 6)");

                entity.Property(e => e.LateComingDays).HasColumnType("decimal(9, 6)");

                entity.Property(e => e.ModifiedOn).HasColumnType("datetime");

                entity.Property(e => e.ModifiedTerminal).HasMaxLength(50);

                entity.Property(e => e.PayableDays).HasColumnType("decimal(9, 6)");

                entity.Property(e => e.WeeklyOffs).HasColumnType("decimal(9, 6)");

                entity.Property(e => e.WorkingDays).HasColumnType("decimal(9, 6)");
            });
            ...
            modelBuilder.Entity<GtEpypve>(entity =>
            {
                entity.HasKey(e => new { e.BusinessKey, e.EmployeeNumber, e.PayPeriod, e.Ercode });

                entity.ToTable("GT_EPYPVE");
            ...
            modelBuilder.Entity<GtEpypyp>(entity =>
            {
                entity.HasKey(e => new { e.BusinessKey, e.PayPeriod });

                entity.ToTable("GT_EPYPYP");
