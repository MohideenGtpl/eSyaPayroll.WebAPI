...
namespace eSyaPayroll.WebAPI.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        /// <summary>
        /// Active/D-Active Employee.
        /// UI Reffered -Employee Master
        /// UI-Param-EmpNo
        /// </summary>
        [HttpGet]
        public async Task<IActionResult> ActiveOrDeActiveEmployee(bool status, int EmpNo)
        {
            var msg = await _EmployeeRepository.ActiveOrDeActiveEmployee(status, EmpNo);
            return Ok(msg);
        }
